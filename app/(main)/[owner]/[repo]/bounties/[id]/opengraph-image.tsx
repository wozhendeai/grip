      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" role="img" aria-label="GRIP Logo">
            ...
            <span style={{ fontSize: 32, fontWeight: 700, color: colors.text }}>GRIP</span>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', flex: 1, justifyContent: 'center', gap: 24 }}>
          <div style={{ fontSize: 56, fontWeight: 700, color: colors.text, lineHeight: 1.2 }}>
            {truncate(bounty.title, 80)}
          </div>
          ...
          <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
            ...
            >
              ...
              <span style={{ fontSize: 32, fontWeight: 600, color: colors.lime }}>
        ...
        >
          ...
          <div style={{ fontSize: 20, color: colors.textSubtle }}>Git Reward & Incentive Platform</div>
        </div>
      </div>
    ),
    { ...size, fonts }
